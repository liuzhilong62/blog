...
<div class="platform-grid">
  <a class="platform-card csdn" href="https://liuzhilong.blog.csdn.net" target="_blank">
    <span class="platform-icon">C</span>
    <div class="platform-name">CSDN</div>
    <div class="platform-desc">技术博客</div>
  </a>
  <a class="platform-card modb" href="https://www.modb.pro/u/4587" target="_blank">
    <span class="platform-icon">M</span>
    <div class="platform-name">墨天轮</div>
    <div class="platform-desc">数据库社区</div>
  </a>
  <a class="platform-card github" href="https://github.com/liuzhilong62" target="_blank">
